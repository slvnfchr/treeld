...
import { isObject, schema, rdfs, dcmitype } from './context';
import Converter from '../converter';

export default () => {

	it('Short repository citation with no subrecords', (done) => {
	...
	it('Full repository citation with source call number and media type', (done) => {
		const id = 'ID of repository';
	...
	it('Repository citation with audio media type', (done) => {
		const id = 'ID of repository';
		const reference = 'Reference in repository';
