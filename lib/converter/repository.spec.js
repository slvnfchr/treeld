...
export default () => {
	it('Short repository citation with no subrecords', (t, done) => {
	...
	it('Full repository citation with source call number and media type', (t, done) => {
		const id = 'ID of repository';
	...
	it('Repository citation with audio media type', (t, done) => {
		const id = 'ID of repository';
		const reference = 'Reference in repository';
