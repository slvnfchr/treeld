 ...
 * @type {Function}
 * @param {import('../deserializer/location').Place|String} obj The place object or string to transform
 * @returns {import('./place').PlaceLD|null} The converted data object
 * @instance
 */
