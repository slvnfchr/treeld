...
import { isObject, dc, dcmitype, rdfs } from './context.js';
import Converter from '../converter.js';

export default () => {
	it('Source citation', (t, done) => {
		...
		const data = createStreamFromObject([{ property: 'DATE', data: source.DATA }, { data: { SOUR: source } }]);
