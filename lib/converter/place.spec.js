...
export default () => {
	it('Country only with default pattern', (t, done) => {
	...
	it('Locality and country with default pattern', (t, done) => {
	...
	it('Locality, region and country with default pattern', (t, done) => {
		const country = 'United Kingdom';
	...
	it('Locality, zipcode and country with default pattern', (t, done) => {
		const country = 'United Kingdom';
	...
	it('Locality, district, region and country with default pattern', (t, done) => {
		const country = 'United Kingdom';
		const region = 'England';
	...
	it('Locality, zipcode, region and country with default pattern', (t, done) => {
		const country = 'United Kingdom';
		const region = 'England';
		const zipcode = 'W1U 6QR';
		const locality = 'London';
	...
	it('Locality, zipcode, country and address with pattern', (t, done) => {
		const country = 'United Kingdom';
	...
	it('Place attribute should be converted to Place schema.org object', (t, done) => {
		const country = 'United Kingdom';
		const locality = 'London';
	...
	it('Place attribute with FORM subproperty and no value should not be converted to Place object and used as FORM for subsequent records', (t, done) => {
		const country = 'United Kingdom';
		const locality = 'London';
		const address = 'Dorset street';
	...
	it('Place attribute with FORM subproperty should be converted to Place object according to that pattern', (t, done) => {
		const country = 'United Kingdom';
		const region = 'England';
		const locality = 'London';
		const address = 'Dorset street';
	...
	it('Place attribute with MAP subproperty should be converted to Place objet with latitude/longitude properties', (t, done) => {
		const country = 'United Kingdom';
		const locality = 'London';
