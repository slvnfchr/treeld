...
export * as skos from './context/skos.js';
export * as wdt from './context/wikidata.js';
export * as rel from './context/relationship.js';
...
export const createObject = (vocabulary, src) => {
	...
	const handler = {
		set(obj, property, value) {
			if (!['type', 'context'].includes(property) && (typeof value !== 'object' || value['@context'])) {
				if (!obj[property]) {
					obj[property] = value;
