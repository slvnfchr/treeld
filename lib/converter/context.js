...
import * as bio from './context/bio';
import * as rdfs from './context/rdfs';
import * as dc from './context/dc';
import * as dcmitype from './context/dcmitype';
import { renameProperty, deleteProperty } from './utils';
...
export const mapProperties = (obj, map) => {
	Object.keys(map)
		...
		.forEach((name) => {
			...
			} else if (obj[map[name]]) { // If property is already defined then transform value to an array of values
