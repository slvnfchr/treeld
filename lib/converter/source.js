 ...
 * @type {Function}
 * @param {import('../deserializer').Chunk} obj The data object to transform
 * @returns {import('./source').Source|undefined} The converted data object
 */
...
const converter = (obj) => {
	...
	if (!obj['@value']) {
		...
		source.context.addVocabulary(schema);
