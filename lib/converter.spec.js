...
import passthrough from './converter/passthrough.spec.js';
import date from './converter/date.spec.js';
import age from './converter/age.spec.js';
...
import multimedia from './converter/multimedia.spec.js';
import file from './converter/file.spec.js';
...
describe('Converter', () => {
	...
	it('Instances should have records method returning all converted chunks', async () => {
		...
		const records = await converter.chunks();
	...
	it('Instances should log informations and errors from each type converter', async () => {
		...
		const data = createStreamFromObject(Object.keys(chunks).map((type) => ({ '@type': type })));
	...
	describe('Passthrough', passthrough);
	...
	describe('Multimedia records', multimedia);
