...
describe('Deserializer', () => {
	...
	it('Emitted chunk for simple object should have expected properties', (t, done) => {
		const level = 0;
		const tag = 'TAG';
	...
	it('Emitted chunks for object with nested hierarchy should have expected properties', (t, done) => {
		const level = 0;
		const tag = 'TAG';
	...
	it('Emitted chunks for object with CONC & CONT records should have expected properties', (t, done) => {
		const level = 0;
		const tag = 'TAG';
		const property = 'PROPERTY';
		const value1 = 'VALUE1';
	...
	it('Emitted chunks for several objects should have expected properties', (t, done) => {
		const tags = [1, 2, 3];
	...
	it('Stream should emit proper chunks according to source file', (t, done) => {
