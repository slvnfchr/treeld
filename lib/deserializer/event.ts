...
import { ChunkWith, ScalarOrObject, MultimediaLink, Multiple } from "./types.ts";
import { DatePeriod, Age, Adoption, IndividualEventType, IndividualEventWithFamilyType, FamilyEventType, GenericEventType } from "../gedcom/types.ts";
...
export type NonEvent = ChunkWith<
  {
